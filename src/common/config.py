...
class Config:
    ...
    class DataCollection:
        ...
        WEB_SCRAPING_URLS = os.getenv("WEB_SCRAPING_URLS", "https://afdc.energy.gov/fuels/electricity_charging_home.html,https://www.energy.gov/eere/electricvehicles/electric-vehicles-charging,https://www.chargepoint.com/drivers/charging-basics").split(",")
        EV_KEYWORDS = [
    ...
    class Model:
        BASE_MODEL_NAME = os.getenv("BASE_MODEL_NAME", "facebook/opt-1.3b")
        HF_TOKEN = os.getenv("HF_TOKEN", "")
        MAX_MODEL_PARAMETERS = "1.3B"
        ...
        FINE_TUNED_MODEL_PATH = os.path.join(Config.MODELS_DIR, "fine_tuned_model")
        FINAL_MODEL_PATH = os.path.join(FINE_TUNED_MODEL_PATH, "final_model")
    ...
    class Monitoring:
        ...
        LOG_FILE = os.path.join(Config.LOGS_DIR, f"pipeline_{datetime.now().strftime('%Y%m%d')}.log")
    ...
    def initialize_paths(cls):
        ...
        cls.Model.FINAL_MODEL_PATH = os.path.join(cls.FINE_TUNED_MODEL_PATH, "final_model")
